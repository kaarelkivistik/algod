...
public class TestData {
    static int[][] smallMatrix = {
            ...
            { 85,  62,  29,   0, 120},
            {185,  58, 149, 120,   0}};
    static int[][] mediumMatrix = {
            {  0, 128,  71,  85, 185,  68, 257, 232, 193, 199,  25, 130},
            {128,   0,  91,  62,  58,  81, 161, 108, 151,  97, 126,  48},
            { 71,  91,   0,  29, 149,  87, 252, 199, 212, 143,  89, 149},
            { 85,  62,  29,   0, 120,  70, 223, 170, 195, 114,  89, 110},
            {185,  58, 149, 120,   0, 117, 107,  50,  98,  85, 165,  56},
            { 68,  81,  87,  70, 117,   0, 189, 164, 126, 178,  48,  62},
            {257, 161, 252, 223, 107, 189,   0,  48,  99, 129, 237, 128},
            {232, 108, 199, 170,  50, 164,  48,   0, 148,  84, 212, 106},
            {193, 151, 212, 195,  98, 126,  99, 148,   0, 183, 174, 101},
            {199,  97, 143, 114,  85, 178, 129,  84, 183,   0, 203, 130},
            { 25, 126,  89,  89, 165,  48, 237, 212, 174, 203,   0, 107},
            {130,  48, 149, 110,  56,  62, 128, 106, 101, 130, 107,   0}};

    static int[][] bigMatrix = {
